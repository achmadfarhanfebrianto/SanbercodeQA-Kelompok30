...
//Edit job title with numbers in all field
describe('failed_editjobtitle', () => {
    it('failed_editjobtitle', () => {
      ...
      cy.get(':nth-child(2) > .oxd-input').clear().type('1234567890')//input job title
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-textarea').clear().type(`1234567890`)//input job deskripsi
      cy.get('.oxd-file-div').attachFile(file)//input job specification
      cy.get(':nth-child(4) > .oxd-input-group > :nth-child(2) > .oxd-textarea').clear().type(`1234567890`)//input note
